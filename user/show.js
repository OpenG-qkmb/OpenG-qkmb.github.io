	...
	const N=4+1;
	var name101=["und","OpenG-qkmb","夢の死のメッセージ","HR","哈儿实验室"],write=["und","我们没有在正常说话，我们在异常说话。","（未填写）","GREEN","哈儿实验室官方账号"],date=["und","2020年7月23日","2020年7月24日","2020年7月30日","2020年10月20日"],info=["und","<h1 style=\"font-size: 70px\"><span style=\"color: #AAAAFF\">呃</span>，<span style=\"color: #FFAAAA\">哈</span><span style=\"color: #AAFFAA\">儿</span></h1>","<p style=\"font-size: 20px\">成功发现<span style=\"color: #FFAAAA\">TGT孩子</span>、<span style=\"color: #FFAAAA\">空洞孩子</span>等一系列危险生物，并冒着生命危险进行试验，为实验室提供了许多重要数据</p>","<a style=\"font-size: 30px; color: #FFFFAA\" href=\"https://mrhaer.github.io/\" target=\"_blank\">我的哈儿公司分部</a>\n<p style=\"color: #AAFFAA; font-size: 40px\">GREEN</p>","<h1 style=\"color: #FFAAAA;\"><strong>哈儿实验室官方账号</strong></h1>"];
	function change(idd)
	{
		var tmp,flag=0;
